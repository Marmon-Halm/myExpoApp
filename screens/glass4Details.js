...
export default function glass4Details(params) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animatable.View animation="fadeInDownBig" style={{ height: '35%', width: '100%', borderRadius: 25, marginBottom: 15, backgroundColor: `#ffc3a0`, padding: 10 }}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", width: '100%' }}>
          ...
          <View style={{ flexDirection: 'column', alignItems: 'center', }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: 80, marginBottom: 5 }}>
              ...
              <TouchableOpacity style={{ backgroundColor: `#a33631`, width: 31, height: 31, borderRadius: 5 }}></TouchableOpacity>
              <TouchableOpacity style={{ backgroundColor: `#ec873c`, width: 31, height: 31, borderRadius: 5 }}></TouchableOpacity>
            </View>
