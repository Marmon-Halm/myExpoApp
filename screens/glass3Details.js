...
export default function glass3Details(params) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animatable.View  animation="fadeInDownBig" style={{ height: '35%', width: '100%', borderRadius: 35, marginBottom: 15, backgroundColor: `#FF9999`, padding: 10 }}>
      ...
      <View style={{ padding: 20 }}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", width: '100%' }}>
          ...
          <View style={{ flexDirection: 'column', alignItems: 'center', }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: 120, marginBottom: 5 }}>
              ...
              <TouchableOpacity style={{ backgroundColor: `#7f9c59`, width: 31, height: 31, borderRadius: 5 }}></TouchableOpacity>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", width: '100%', height: 40, marginBottom: 20 }}>
          <Text style={{ fontWeight: '500', fontSize: 40 }}><Text style={{ color: `#02c38e` }}>$</Text>80</Text>
        ...
        <View style={{ height: '27%', width: '100%', borderRadius: '10', marginBottom: 35 }}>
          <Text style={{ fontSize: 19, fontWeight: '500', color: 'gray', marginBottom: 8 }}>Item Description</Text>
