...
export default function glass7Details(params) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animatable.View animation="fadeInDownBig" style={{ height: '35%', width: '100%', borderRadius: 25, marginBottom: 15, backgroundColor: `#94a474`, padding: 10 }}>
      ...
      <View style={{ padding: 20 }}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", width: '100%' }}>
          ...
          <View style={{ flexDirection: 'column', alignItems: 'center', }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: 35, marginBottom: 5 }}>

              <TouchableOpacity style={{ backgroundColor: '#2e8264', width: 31, height: 31, borderRadius: 5 }}></TouchableOpacity>
            </View>
