...
export default function glass2Details(params) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animatable.View  animation="fadeInDownBig" style={{ height: '35%', width: '100%', borderRadius: 35, marginBottom: 15, backgroundColor: `#99CCFF`, padding: 10 }}>
      ...
      <View style={{ padding: 20 }}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", width: '100%' }}>
          ...
          <View style={{ flexDirection: 'column', alignItems: 'center', }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: 80, marginBottom: 5 }}>
              ...
              <TouchableOpacity style={{ backgroundColor: `#364332`, width: 31, height: 31, borderRadius: 5 }}></TouchableOpacity>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", width: '100%', height: 40, marginBottom: 20 }}>
          <Text style={{ fontWeight: '500', fontSize: 40 }}><Text style={{ color: `#02c38e` }}>$</Text>99</Text>
