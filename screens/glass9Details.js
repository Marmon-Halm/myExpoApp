...
export default function glass9Details(params) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ height: '35%', width: '100%', borderRadius: 25, marginBottom: 15, backgroundColor: `#fff6dc`, padding: 10 }}>
      ...
      <View style={{ padding: 20 }}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", width: '100%' }}>
          ...
          <View style={{ flexDirection: 'column', alignItems: 'center', }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: 150, marginBottom: 5 }}>
...
{/* 
        <View style={{ flexDirection: "row", justifyContent: "space-between", width: '100%', height: 40, marginBottom: 20 }}>
          <Text style={{ fontWeight: '500', fontSize: 40 }}><Text style={{ color: `#02c38e` }}>$</Text>65</Text>
