...
export default function glass7Details(params) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animatable.View animation="fadeInDownBig" style={{ height: '35%', width: '100%', borderRadius: 25, marginBottom: 15, backgroundColor: `#06beb6`, padding: 10 }}>
      ...
      <View style={{ padding: 20 }}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", width: '100%' }}>
          ...
          <View style={{ flexDirection: 'column', alignItems: 'center', }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: 120, marginBottom: 5 }}>
              ...
              <TouchableOpacity style={{ backgroundColor: 'black', width: 31, height: 31, borderRadius: 5 }}></TouchableOpacity>
              <TouchableOpacity style={{ backgroundColor: 'brown', width: 31, height: 31, borderRadius: 5 }}></TouchableOpacity>
              <TouchableOpacity style={{ backgroundColor: 'gray', width: 31, height: 31, borderRadius: 5 }}></TouchableOpacity>
            </View>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", width: '100%', height: 40, marginBottom: 20 }}>
          <Text style={{ fontWeight: '500', fontSize: 40 }}><Text style={{ color: `#02c38e` }}>$</Text>70</Text>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%', marginBottom: 20 }}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
            ...
            <Ionicons name="star" size={22} color="#02c38e" />
            <Ionicons name="star-half-sharp" size={22} color="#02c38e" />
        ...
        <View style={{ height: '27%', width: '100%', borderRadius: '10', marginBottom: 35 }}>
          ...
          <View style={{ width: '100%', marginBottom: 5 }}>
            ...
            <Text style={{ fontSize: 21, fontWeight: '400', color: 'black', marginBottom: 3 }}>Sizes are 'Regular and Large'</Text>
